...
class TestTileConstructor {
	...
	/**
	 * This method tests to check that all the 1-point tiles can be made from the
	 * appropriate upper- and lower-case letters and that they have the appropriate
	 * point value
	 */
	@Test
	...
	/**
	 * Similar to above. This method tests to ensure that all of two-point letters
	 * are created from both capital and lowercase letters
	 */
	@Test
	...
	/**
	 * Similar to above. This method tests to ensure that all of three-point letters
	 * are created from both capital and lowercase letters
	 */
	@Test
	...
	/**
	 * Similar to above. This method tests to ensure that all of four-point letters
	 * are created from both capital and lowercase letters
	 */
	@Test
	...
	/**
	 * Similar to above. This method tests to ensure that all of five-point letters
	 * are created from both capital and lowercase letters
	 */
	@Test
	...
	/**
	 * Similar to above. This method tests to ensure that all of eight-point letters
	 * are created from both capital and lowercase letters
	 */
	@Test
	...
	/**
	 * Similar to above. This method tests to ensure that all of ten-point letters
	 * are created from both capital and lowercase letters
	 */
	@Test
